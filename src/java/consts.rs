...
pub const CLASS_PATH_64: [&'static str; 20] = [
    "java/.",
...
pub const CLASS_PATH_32: [&'static str; 20] = [
    "java/.",
    ...
    "java/jaxb-runtime.jar",
    "java/lwjgl.jar",
    "java/lwjgl-natives-windows-x86.jar",
    "java/lwjgl-glfw.jar",
    "java/lwjgl-glfw-natives-windows-x86.jar",
    "java/lwjgl-jemalloc.jar",
    "java/lwjgl-jemalloc-natives-windows-x86.jar",
    "java/lwjgl-opengl.jar",
    "java/lwjgl-opengl-natives-windows-x86.jar",
    "java/lwjgl_util.jar",
    "java/sqlite-jdbc-3.27.2.1.jar",
    "java/trove-3.0.3.jar",
    "java/uncommons-maths-1.2.3.jar",
...
pub const VM_ARGS_64: [&'static str; 8] = [
...
pub const VM_ARGS_32: [&'static str; 9] = [
    "-Djava.awt.headless=true",
    "-Xms768m",
    "-Xmx768m",
    "-Dzomboid.steam=1",
    "-Dzomboid.znetlog=1",
    "-Djava.library.path=natives/;natives/win32/;.",
    "-XX:+UseG1GC",
    "-XX:-CreateCoredumpOnCrash",
    "-XX:-OmitStackTraceInFastThrow",
];
